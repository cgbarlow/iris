...
{#snippet navIcon(icon: string)}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" width="16" height="16" aria-hidden="true" style="flex-shrink: 0">
		...
		{:else if icon === 'ai'}
			<path d="M176,232a8,8,0,0,1-8,8H88a8,8,0,0,1,0-16h80A8,8,0,0,1,176,232Zm40-128a88,88,0,1,1-146.3-65.8C69.7,38.2,80,34,80,26a24,24,0,0,1,48,0c0,7.9,10.1,12.1,10.2,12.1A88,88,0,0,1,216,104ZM200,104a72,72,0,0,0-72-72,25.6,25.6,0,0,0-1.8,0,24.2,24.2,0,0,1-8.2-18A8,8,0,0,0,96,10.2V104a8,8,0,0,1-16,0V26.5A72,72,0,0,0,56,104c0,27.7,15.5,51.9,40,64.5V184a8,8,0,0,0,8,8h48a8,8,0,0,0,8-8V168.5C184.5,155.9,200,131.7,200,104Z"/>
		{/if}
	</svg>
{/snippet}
