...
{#snippet navIcon(icon: string)}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" width="16" height="16" aria-hidden="true" style="flex-shrink: 0">
		...
		{:else if icon === 'aggregate'}
			<path d="M227.81,66.37l-.08-.19a16,16,0,0,0-14.86-10.18H43.13A16,16,0,0,0,28.27,66.18l-.08.19a16.07,16.07,0,0,0,3,17.63L96,140.55V208a16,16,0,0,0,24.87,13.32l32-21.34A16,16,0,0,0,160,186.67V140.55l64.76-56.74A16.07,16.07,0,0,0,227.81,66.37Zm-11.07,6.26L152,129.45V186.67l-32,21.33V129.45L55.26,72.63l0-.26-.09-.37H200.81l-.06.37Z"/>
		{:else if icon === 'lock'}
