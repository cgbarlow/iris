...
<!-- The preference sections above (Theme / Default Notation / Visual
     ...
     v6.0.0 (ADR-164): the "MCP Connections" section pointing at
     /settings/mcp-pairing was removed when the pairing flow was
     replaced by OAuth. MCP clients now configure OAuth in their own
     connector settings (e.g. claude.ai → Connectors → Configure). -->
