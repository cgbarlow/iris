...
<svelte:head>
	<title>Entity Detail — Iris</title>
</svelte:head>
...
<h1 class="text-2xl font-bold" style="color: var(--color-fg)">Entity Detail</h1>
<p class="mt-2" style="color: var(--color-muted)">Entity ID: {page.params.id}</p>
