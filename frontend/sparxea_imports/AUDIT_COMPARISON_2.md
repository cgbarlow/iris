# Audit Comparison — Iteration 2 vs 1
...
|--------|----------|----------|-------|
| Total issues | 464 | 464 | +0 (0.0%) |
| Diagrams with issues | 160 | 160 | 0 |
| Critical | 0 | 0 | 0 |
| High | 132 | 132 | 0 |
| Medium | 332 | 332 | 0 |
| Low | 0 | 0 | 0 |
...
| Type | Iter 1 | Iter 2 | Delta |
|------|----------|----------|-------|
| missing_packages | 1 | 1 | 0 |
| missing_waypoints | 146 | 146 | 0 |
| node_overlap | 160 | 160 | 0 |
| text_overflow | 157 | 157 | 0 |

## Fixed (0)

_No issues fixed in this iteration._

## Regressions (0)

_No regressions._

## Persistent Issues (464)
...
### missing_packages (1)
- AIXM_v.5.1.1: API has 7 package nodes, DOM has 0
