...
async def get_relationship(
    ...
    return {
        "id": row[0],
        "source_element_id": row[1],
        "target_element_id": row[2],
        ...
        "source_element_name": row[12] or "",
        "target_element_name": row[13] or "",
    }
...
async def list_relationships(
    ...
    *,
    ...
    """List relationships, optionally filtered by element involvement."""
