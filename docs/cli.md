...
| `iris patch diagram <id> --from-json FILE [--expected-version N] [--change-summary S]` | Atomic incremental canvas edits — `{"operations": [...]}`, 1–200 ops incl. `sync_labels` (ADR-252) |
